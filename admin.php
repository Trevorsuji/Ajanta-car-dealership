...
<html lang="en" dir="ltr">
	<head>
		...
		<title>AJANTA | admin</title>
	</head>
	<body>
		<header>
			<div class="heading">
				<h1><a href="index.php"><i class="fas fa-angle-double-left"></i></a>AJANTA <span> Admin </span> </h1>
			</div>
			<nav>
				<h3>ORDERS</h3>
				<h3>USERS</h3>
		...
		<div id='tab' class="staff">
            <div class="container">
				<div class="staff-flex-box">
					<div class="staff-form">
						...
						<div class="add">
							<form action="admin.php" method="post">
								...
								<input type="password" name="staff_re_password" required>
								<input class="add-staff-submit" type="submit" name="add-staff-submit" value="Create Staff Member">
							</form>
						</div>
					</div>
                </div>
