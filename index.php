	...
	<body>
                    ...
                    if(isset($_SESSION['username'])){
                        echo '<div class="profile">';
        					    if($_SESSION['role'] == 'super_admin'){
                                    echo '<a href="admin.php" title="Super Admin Panel"><i class="fas fa-door-open"></i></a>';
                                } else if($_SESSION['role'] == 'staff'){
                                    echo '<a href="staff.php" title="Staff Panel"><i class="fas fa-door-open"></i></a>';
                                }
		...
		<section id="login" class="showcase">
			<div class="showcase-text" data-aos="slide-up">
				...
				<div class="forms">
					<form class="login-form" action="index.php" method="post" onsubmit="return validateLoginForm()">
						<input type="email" name="email" placeholder="Email" required> <br>
						<input type="password" name="password" placeholder="Password" required minlength="1"> <br>
						<button type="submit" name="login-submit"> Log in </button>
					</form>
					<form class="signup-form" action="index.php" method="post" onsubmit="return validateSignupForm()">
						<input type="text" name="username" placeholder="Username" required pattern="[A-Za-z0-9_]{3,}" title="Username must be at least 3 characters and can contain letters, numbers, and underscores"> <br>
		                <input type="email" name="email" placeholder="Email" required> <br>
		                <input type="password" name="password" placeholder="Password" required minlength="8" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}" title="Password must be at least 8 characters with uppercase, lowercase, number and special character"> <br>
		                <input type="password" name="re-password" placeholder="Retype password" required> <br>
		                <button type="submit" name="signup-submit"> Sign up </button>
					</form>
				</div>
				<h1> DRIVE YOUR DREAM</h1>
				<p>One Stop Dealership</p>
			</div>
