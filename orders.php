...
<html lang="en" dir="ltr">
	<head>
		...
		<title>AJANTA | product</title>
	</head>
	<body>
		<div class="order-all">
			<div class="heading">
				<h1><a href="javascript:history.back();"><i class="fas fa-angle-double-left"></i></a>AJANTA <span> Admin </span> </h1>
			</div>
			<div class="user-info">
					...
					while($row = $order_items->fetch_assoc()){
						...
						if($product_1 == -1){
							...
							<div class="item">
								...
								<h6 class="item-price">kes'.$item['price'].'</h6>
							</div>
							';
						} else {
							$item = new Car();
